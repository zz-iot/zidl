...
pub const Sample = struct {
    ...
    nums: extern struct { _maximum: u32 = 0, _length: u32 = 0, _buffer: ?[*]i32 = null, _release: bool = false } = .{},
    ...
    pub fn serialize(writer: anytype, value: @This()) !void {
        ...
        try writer.writeU32(value.nums._length);
        if (value.nums._buffer) |_sb| {
            for (_sb[0..value.nums._length]) |_se| {
    ...
    pub fn deserializeInto(out: *@This(), reader: *zidl_rt.CdrReader, allocator: std.mem.Allocator) !void {
        ...
        }
        {
            ...
            out.nums._length = _n;
            out.nums._maximum = _n;
            if (_n > 0) {
                const _buf = try allocator.alloc(i32, _n);
                out.nums._buffer = _buf.ptr;
                out.nums._release = true;
                for (_buf) |*_se| {
                    _se.* = try reader.readI32();
                }
            }
        }
        for (0..3) |_i0| {
    ...
    pub fn clone(self: @This(), alloc: std.mem.Allocator) !@This() {
        ...
        if (self.nums._length > 0) {
            ...
            if (self.nums._buffer) |_sb| @memcpy(_buf, _sb[0..self.nums._length]);
            result.nums = .{ ._buffer = _buf.ptr, ._length = self.nums._length, ._maximum = self.nums._length, ._release = true };
        }
        errdefer {
...
pub const Greeter = extern struct {
    ...
    pub const Vtable = struct {
        ...
        get_allocator: *const fn (*anyopaque) std.mem.Allocator,
    };
...
pub const AdvancedGreeter = extern struct {
    ...
    pub const Vtable = struct {
        ...
        get_c_abi_handle: *const fn (*anyopaque) *anyopaque,
        get_allocator: *const fn (*anyopaque) std.mem.Allocator,
        as_Greeter: *const fn (*anyopaque) Greeter,
    };
